...
class MyIndividualApp extends StatefulWidget {
  const MyIndividualApp ({Key key = const Key("any key")}) : super(key: key);

  @override
  _MyIndividualAppState createState() => _MyIndividualAppState();
}

class _MyIndividualAppState extends State<MyIndividualApp> {
  @override
...
class IndividualApp extends StatelessWidget {
  SpeedDial buildSpeedDial() {
    return SpeedDial(
      ...
      children: [
        SpeedDialChild(
          child: Icon(Icons.lock, color: Color(0xFF075E54)),
    ...
    return showDialog(
        ...
        builder: (context){
          return FloatingActionButton(
            backgroundColor:Colors.white,
            child: Icon(Icons.lock,size: 30,color: Color(0xFF075E54)),
            onPressed: (){
